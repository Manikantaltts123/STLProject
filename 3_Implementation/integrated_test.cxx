 ...
 * @brief Test file for Integrated File
 ...
 * @brief Check for Valid case of user option in choosing restaurant
 ...
 * @brief Check for Invalid case of user option in choosing restaurant
 ...
 * @brief Check for correct entries in file map object
...

{
    ...
    ASSERT_EQ("csv_files/Dominos_Menu.csv",cs_map[1]);

    ASSERT_EQ("csv_files/McDonalds_Menu.csv",cs_map[2]);
 ...
 * @brief Check for wrong entries in file map object
 ...
 * @brief Check for correct entries in dominos restaurant item vector object
...

{
   ...
   csv_map[1]="./csv_files/Dominos_Menu.csv";
 ...
 * @brief Check for wrong entries in dominos restaurant item vector object
 ...
 * @brief Check for correct entries in McDonalds restaurant item vector object
...

{
   ...
   csv_map[2]="./csv_files/McDonalds_Menu.csv";
 ...
 * @brief Check for wrong entries in McDonalds restaurant item vector object
 ...
 * @brief Check for correct entries in price map object
 ...
 * @brief Check for wrong entries in price map object
 ...
 * @brief Check if calculated price of user's order is correct
 ...
 * @brief Check if calculated price of user's order is wrong
 ...
 * @brief Check if calculated final price of user's order is correct
 ...
 * @brief Check for correct entries in log file
 ...
 * @brief Check for wrong entries in log file
 ...
 * @brief Check if the user is member in CubeEatery
 ...
 * @brief Check if the user is not a member in CubeEatery
 ...
 * @brief Check for correct grand total of user's order
 ...
 * @brief Check for incorrect grand total of user's order
...
/**
 * @brief Driver function for test cases
 * 
 * @param argc 
 * @param argv 
 * @return int 
